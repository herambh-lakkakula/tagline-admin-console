...
- https://github.com/creativetimofficial/material-dashboard-react/issues/16 (please check the following page: https://demos.novel-logiks.com/material-dashboard-react/#/rtl/rtl-page)
### Major style changes
### Deleted components
### Added components
...
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.novel-logiks.com/material-dashboard-react/#/documentation/routing-system)
...
- Added design from Material Dashboard by Sunil Lakkakula
